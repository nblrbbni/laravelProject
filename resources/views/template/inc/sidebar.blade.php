    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::path() === 'arsip' ? 'bg-primary' : '' }}"
                        href="{{ route('arsip') }}">
                        <span class="nav-link-title"> Arsip </span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Request::path() === 'perusahaan' ? 'bg-primary' : '' }}"
                ...
                @if (auth()->user()->role == 'Admin')
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item {{ Request::path() === 'role' ? 'bg-primary' : '' }}"
                                href="{{ route('role') }}" rel="noopener">
                                Role
                            </a>
                            <a class="dropdown-item {{ Request::path() === 'pengguna' ? 'bg-primary' : '' }}"
                                href="{{ route('pengguna') }}" rel="noopener">
                                Pengguna
                            </a>
                            <a class="dropdown-item {{ Request::path() === 'klasifikasi' ? 'bg-primary' : '' }}"
                                href="{{ route('klasifikasi') }}" rel="noopener">
                                Klasifikasi
                            </a>
                        </div>
                    </li>
